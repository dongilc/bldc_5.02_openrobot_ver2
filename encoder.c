...
// Custom Encoder use.
		...
		#define HW_HYB_ENC_A_PORT			HW_SPI_PORT_SCK // HW_SPI_PORT_SCK @VER0.1A, VER0.2, VESCular
		#define HW_HYB_ENC_A_PIN			HW_SPI_PIN_SCK  // HW_SPI_PIN_SCK @VER0.1A, VER0.2, VESCular
		#define HW_HYB_ENC_B_PORT			HW_SPI_PORT_MISO // HW_SPI_PORT_MISO @VER0.1A, VER0.2, VESCular
		#define HW_HYB_ENC_B_PIN			HW_SPI_PIN_MISO  // HW_SPI_PIN_MISO @VER0.1A, VER0.2, VESCular
		#define HW_HYB_ENC_I_PORT			HW_SPI_PORT_NSS  // HW_SPI_PORT_NSS @VER0.1A, VER0.2, VESCular
		#define HW_HYB_ENC_I_PIN			HW_SPI_PIN_NSS   // HW_SPI_PIN_NSS @VER0.1A, VER0.2, VESCular
