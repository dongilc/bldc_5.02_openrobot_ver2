...
#include "openrobot/mc_header_custom/m.h"

//#define USE_CUSTOM_ABI_ENCODER_AT_SPI   // If it is enabled, Arduino SPI Communication impossible
#define USE_COMMPORT_AS_SPI // Use Communication port for EasyCAT - SPI Communication
////////////////////////////////////////////////////////////////////////////////
...
#ifndef USE_CUSTOM_ABI_ENCODER_AT_SPI // if USE_CUSTOM_ABI_ENCODER_AT_SPI is not enabled
...
#define SERVO_OUT_ENABLE			1	//0	// Enable servo output
#endif
